...
- [x] **Integrate cart & checkout** _(Snipcart implementation details live in `docs/operations/snipcart-setup.md`)_
  ...
  - [ ] Configure tax, shipping rules, and payment methods; test end-to-end purchase flow in sandbox mode (`docs/operations/snipcart-setup.md`). _(Shipping + tax matrix documented 2025-11-02; awaiting Snipcart sandbox credentials to apply settings and run QA.)_
